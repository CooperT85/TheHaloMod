...
{
    class CrystalNeedleProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            ProjectileID.Sets.Homing[projectile.type] = true;
            DisplayName.SetDefault("CrystalNeedleProjectile");
        }
        ...
        public override void AI()
        {
            ...
            ///Dust.NewDust(projectile.position + projectile.velocity, projectile.width, projectile.height, 254, projectile.velocity.X * -0.5f, projectile.velocity.Y * -0.5f);
        }
